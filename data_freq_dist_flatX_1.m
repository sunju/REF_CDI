...
title('Squared Four. magnitudes for delta with block ref.')
subplot(3,1,2)
stem3([-512:511],[-512:511],fftshift(ys),'blue')
title('Squared Four. magnitudes for delta with slit ref.')
subplot(3,1,3)
stem3([-512:511],[-512:511],fftshift(yp),'magenta')
title('Squared Four. magnitudes for delta with pinhole ref.')