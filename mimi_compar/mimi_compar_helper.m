% Reproduces the images in Figure 9 of the paper
...
%%
save('mimi_compar_helper.mat')
imwrite(block_img_rec,'block_mimi.png');
imwrite(slit_img_rec,'slit_mimi.png');
imwrite(pinhole_img_rec,'pinhole_mimi.png');
imwrite(HIO_block_img_rec,'HIO_block_mimi.png');
imwrite(HIO_slit_img_rec,'HIO_slit_mimi.png');
imwrite(HIO_pinhole_img_rec,'HIO_pinhole_mimi.png');
imwrite(HIO_img_rec,'HIO_mimi.png');