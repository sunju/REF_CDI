...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    plhs[0] = mxCreateDoubleMatrix(N2, 1, mxREAL);/*mxReal is our data-type*/
    plhs[1] = mxCreateDoubleMatrix(N2, 1, mxREAL);/*mxReal is our data-type*/
    ...
    for(i=0;i<M;i++)
    {
        ...
        V0r=fr[i]*E_1x;
        V0i=fi[i]*E_1x;/*Some redundant FLOPs here*/
        ...
        Note: lots of redundant FLOPS here...should be optimized.*/
            ...
            {   /*Note: We need to make sure the convolution wraps around 
                ...
                outArrayR[xind]+= V0r*E_23x;
                outArrayI[xind]+= V0i*E_23x;
            }
    }
    free(E_2x);
    return;
